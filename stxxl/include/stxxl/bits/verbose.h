...
#define STXXL_VERBOSE_LEVEL -1
 ...
 #define STXXL_MSG(x) _STXXL_PRINT("OUT: STXXL-MSG", x, _STXXL_PRINT_FLAGS_DEFAULT)
#else
// Please do not report STXXL problems with STXXL_MSG disabled!
 ...
 #define STXXL_ERRMSG(x) _STXXL_PRINT("ERROR: STXXL-ERRMSG", x, _STXXL_PRINT_FLAGS_ERROR)
#else
